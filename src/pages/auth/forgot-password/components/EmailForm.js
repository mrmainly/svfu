...
const EmailForm = () => {
    ...
    const { handleOpenEmailFormVersion, handleOpenVerifyFormVersion } =
    ...
    return (
        <div className="form">
            ...
            >
                Введите вашу почту, которую вы ввели при регистрации. Если вы
                забыли адрес электронной почты, проверьте данные.
            </Text>
